...
class ParkingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parking" do
    assert_difference("Parking.count") do
      post parkings_url, params: { parking: { location: @parking.location, name: @parking.name, number: @parking.number } }
    end
  ...
  test "should update parking" do
    patch parking_url(@parking), params: { parking: { location: @parking.location, name: @parking.name, number: @parking.number } }
